...
public class VideoTranslationWorker {
    ...
    public static void main(String[] args) {
        ...
        Worker worker = factory.newWorker(Shared.VIDEO_TRANSLATION_TASK_QUEUE);

        // Register a Workflow implementation with this Worker
        // The implementation must be known at runtime to dispatch Workflow tasks
        // Workflows are stateful so a type is needed to create instances.
        worker.registerWorkflowImplementationTypes(VideoTranslationWorkflowImpl.class);
        ...
        worker.registerActivitiesImplementations(new TranslationActivityImpl());
